...
{ 
    public class GizmoDrawing
    {
        ...
        public static void DrawSquareOutline(Vector3[] corners, Color outlineColor)
        {
            UnityEditor.Handles.DrawSolidRectangleWithOutline(corners, Color.clear, outlineColor);
        }
